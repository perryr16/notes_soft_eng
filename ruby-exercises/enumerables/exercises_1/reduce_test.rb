...
class ReduceTest < Minitest::Test
  ...
  def test_capitalize_keywords_in_phrase_one_fish_two_fish_red_fish_blue_fish
    ...
    # Your code goes here
    result = keywords.reduce('one fish two fish red fish blue fish') do |sentence, word|
  ...
  def test_divide_560_by_a_bunch_of_numbers
    ...
    # Your code goes here
    result = numbers.reduce(560) do |quot, num|
      quot / num
    end
  ...
  def test_subtract_smallest_values_from_100
    ...
    # Your code goes here
    result = elements.reduce(100) do |difference, array|
