...
class NestedTest < MiniTest::Test
  ...
  def test_list_of_dishes_names_for_olive_garden
    ...
    # binding.pry
    #=======================
    dishes_names = stores[:olive_garden][:dishes].map{|val| val[:name]}
  ...
  def test_list_of_employees_across_all_restaurants
    ...
    # olive_garden_employees = stores[:olive_garden][:employees]
    # dennys_employees = stores[:dennys][:employees]
    # macdonalds_employees = stores[:macdonalds][:employees]


    #=======================
    employee_names = []
    stores.each do |store, details|
      employee_names << details[:employees]
    end
  ...
  def test_full_menu_price_for_olive_garden
    ...
    full_menu_price = stores[:olive_garden][:dishes].sum { |element| element[:price] }
    #=======================
